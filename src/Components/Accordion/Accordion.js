  ...
  const collapse = [
    {
      ...
      answer:
        "CollabAct provides a platform for collaboration. There is an immense gap and contradiction; between unemployment in the nation and the companies not getting the right team.We CollabAct, will find out the best of the talent and coach them to become Business Influencer. At the same time, we understand the needs and challenges of the businesses. And become a mediator and connect the right Business Influencer with the right company. We couple the talents of the candidates to the needs of the companies.",
    },
    {
      question: "What does CollabAct do for the Candidates?",
      answer:
        "After joining CollabAct, candidates are given counseling; they know more about their interests and competencies. One must know about their talents along with their passions. We provide them with skill-based and mindset training. It will be an entire journey from the Candidate to a Business Influencer. Then they will be associated with established companies according to their interest and choice.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Executive Business Partners (EBPs) are the Business Influencers who have finished their training and decided to work on the goals of one particular company. They will have a tie-up with a company and will have to perform their development and growth activities. They are not employees; they are EBPs, who will be paid in the percentage of the sales they make.",
    },
    {
      question: "Who are EBLs? What do they do?",
      answer:
        "Executive Business Leaders (EBLs) are the Business Influencers who have finished their training and decided to work in one segment. Not working with one particular company, but working on various products of different companies. They will not have a tie-up with one company but with various products of various companies. They get a choice on which products they would like to work with.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Of course, you can. Just send us a mail at info@collabact.com with your details and how you would like to connect with us. You can also contact us on our social media pages.",
    },
  ];
  return (
    <div className="">
        ...
        <div className="">
          {collapse.map((col) => (
            <div className="collapse collapse-arrow rounded-lg my-[0.7%]">
              ...
              <div className="collapse-title bg-[#f7f7f7] text-[#6e6c6c] peer-checked:bg-[#0d11f4] peer-checked:text-[#ffffff] font-bold border-l-4 border-[#240df4] rounded-lg">
                {col.question}
              </div>
